...
public class SarRuleController {
    ...
    public ApiResponse<List<RuleDTO>> uploadRule(@RequestParam("file") MultipartFile file,
        ...
        try {
            ...
            List<RuleDTO> rules = sarRuleService.uploadRuleAll(file, userId, libraryId);
    ...
    public ApiResponse<ChecklistImportResultDTO> importChecklist(@RequestParam("file") MultipartFile file,
        ...
        try {
            Long userId = SecurityUtils.getUserId(authentication);
            ChecklistImportResultDTO result = checklistRuleImportService.importQtpChecklist(file, userId, libraryId, "SAR");
    ...
    public ApiResponse<PageResponse<RuleDTO>> listRules(
        ...
        try {
            ...
            PageResponse<RuleDTO> result = sarRuleService.listRules(page, size, userId, role, libraryId);
