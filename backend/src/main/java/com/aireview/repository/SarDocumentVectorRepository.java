...
public class SarDocumentVectorRepository {
    ...
    public void deleteByTaskId(String taskId) {
        jdbcTemplate.update("DELETE FROM sar_document_blocks WHERE task_id = ?", taskId);
    }

    public void saveAll(List<SarDocumentBlock> blocks) {
        if (blocks == null || blocks.isEmpty()) return;

        String sql = """
                INSERT INTO sar_document_blocks (
        ...
        jdbcTemplate.batchUpdate(sql, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement ps, int i) throws SQLException {
                SarDocumentBlock block = blocks.get(i);
    ...
    public String ensureHnswIndex(String embeddingModel, int dimension) {
        ...
        String indexName = "idx_sar_doc_blocks_hnsw_" + strategy + "_" + dimension + "_" + shortHash(model);
        ...
        String sql = "CREATE INDEX IF NOT EXISTS " + indexName
                + " ON sar_document_blocks USING hnsw ((" + expression + ") " + operatorClass + ")"
    ...
    public List<ScoredSarDocumentBlock> findNearest(String taskId,
    ...
    private List<ScoredSarDocumentBlock> queryCosine(String taskId,
                                                   String model,
                                                   String queryVector,
                                                   int dimension,
                                                   int limit,
    ...
    private List<ScoredSarDocumentBlock> queryBinaryQuantized(String taskId,
                                                            String model,
                                                            String queryVector,
                                                            int dimension,
                                                            int limit,
    ...
    private ScoredSarDocumentBlock mapScoredBlock(ResultSet rs, int rowNum) throws SQLException {
        ...
        return new ScoredSarDocumentBlock(block, rs.getDouble("similarity"));
    }
    ...
    public record ScoredSarDocumentBlock(SarDocumentBlock block, double score) {
    }
}
